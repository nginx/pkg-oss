...
The following is a set of guidelines for contributing to NGINX opensource
...
available bug report issue template. Please ensure the bug has not already been
...
- Fill in [our pull request template](https://github.com/nginx/pkg-oss/blob/master/.github/pull_request_template.md).
