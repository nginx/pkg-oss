...
We advise users to run or update to the most recent release of NGINX packages. Older versions of NGINX packages may not have all enhancements and/or bug fixes applied to them.
